...
class SongListAdapter(private val context: Activity, private  val songIdList : List<String>)
    ...
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): MyViewHolder {
        val itemView = LayoutInflater.from(context).inflate(R.layout.song_list_item_recycler_row, parent, false)
                ...
                song?.apply {
                    ...
                    holder.itemView.setOnClickListener {
                        ...
                        if(PlayerActivity.nowPlayingID==id)
                        {
                            ...
                            intent.putExtra("class","SongListAdapter")
                            PlayerActivity.SongList=songIdList
                            PlayerActivity.musicListPA=musicListPA
                            context.startActivity(intent)
                        }
